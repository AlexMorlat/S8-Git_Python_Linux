            ...
            dbc.Card([
                ...
                dbc.CardBody([
                        ...
                        html.Div(
                            ...
                            html.P(f"Nombre de lignes : {len(df)}"),
                            html.P(f"Prix minimum : {df['Prix'].min()} $"),
                            html.P(f"Prix maximum : {df['Prix'].max()} $"),
                            html.P(f"Variation du Prix : {round((df['Prix'][len(df)-1]-df['Prix'][0])/df['Prix'][0],2)} %"),
